                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {/* Enable GZCLP Active Workout Mode */}
                                    <label className="flex items-center justify-between p-3 bg-zinc-900 border border-zinc-800 rounded-xl cursor-pointer hover:border-zinc-700 transition-colors">
                                        <span className="text-sm font-bold text-emerald-400">Enable GZCLP Active Workout</span>
                                        <input
                                            type="checkbox"
                                            checked={formData.preferences?.enableGZCLP || false}
                                            onChange={e => setFormData(prev => ({
                                                ...prev,
                                                preferences: { ...prev.preferences, enableGZCLP: e.target.checked }
                                            }))}
