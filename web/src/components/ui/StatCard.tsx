...
export function StatCard({ label, value, subtext }: { label: string, value: string, subtext?: string }) {
    return (
        <div className="bg-zinc-900/40 backdrop-blur-md border border-zinc-800/50 p-4 md:p-6 rounded-2xl flex flex-col justify-between hover:bg-zinc-800/40 transition-all duration-300 group shadow-lg shadow-black/20">
            ...
            <div>
                <div className="text-2xl md:text-3xl font-bold text-white tracking-tight tabular-nums">{value}</div>
